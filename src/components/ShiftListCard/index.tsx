...
export const ShiftListCard = ({shift}: {shift: Shift}) => {
  ...
  return (
    <div className="max-w-lg mx-auto mb-4 cursor-pointer" onClick={() => navigate(`/shift/${shift.id}`)}>
      ...
      <div className="max-w-md mx-auto bg-white shadow-md rounded-lg p-4 mb-4">
       ...
       {notes && <div className="text-gray-800, bg-gray-100 p-2 rounded-md mt-4 text-sm">
          <p>
            {notes}
          </p>
        </div>}
